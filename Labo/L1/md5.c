...
void MD5UpdateOnce(MD5_CTX *context, unsigned char *input) {
 ...
 */
void MD5Final(unsigned char digest[16], MD5_CTX *context, bool padding) {
...
MD5_CTX digestTwoBlocks(char *string1, char *string2) {
  ...
  MD5Init(&context);
  MD5UpdateOnce(&context, string1);
  MD5UpdateOnce(&context, string2);
